<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="desc" label="文章摘录">
        <uni-easyinput placeholder="文章摘录" v-model="formData.desc" trim="both"></uni-easyinput>
      </uni-forms-item>
      ...
      <uni-forms-item name="picUrl" label="封面大图">
        <uni-data-checkbox :multiple="true" v-model="formData.picUrl"></uni-data-checkbox>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/talk-article.js';

  const db = uniCloud.database();
  const dbCollectionName = 'talk-article';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,title,content,desc,province,article_status,last_comment_user_id,picUrl,publish_date,last_modify_date,publish_ip").get().then((res) => {

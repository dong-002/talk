...
<script>
  import { validator } from '../../js_sdk/validator/talk-comment.js';

  const db = uniCloud.database();
  const dbCollectionName = 'talk-comment';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("article_id,user_id").get().then((res) => {
